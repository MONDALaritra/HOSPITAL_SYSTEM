...
<head>
<meta charset="UTF-8">
<title>Allergy Appointment</title>
<style>
	body{
		background:url("Image/allergy-back.jpg");
...
<%
	...
	<%String appointment1 = request.getParameter("appointment");
     ...
     <%String error1 = request.getParameter("error");
         ...
         <% } %> 
	<div class="allergy-appoint">
		<form action="AllergyServlet" method="post">
			<h2>ALLERGY SPECIALIST</h2>
			<br>
			<div class="infield">
