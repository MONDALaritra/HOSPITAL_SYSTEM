...
<head>
<meta charset="UTF-8">
<title>KIDNEY SPECIALIST</title>
<style>
	body{
		background:url("Image/kidney-back.jpeg");
...
<%
	...
	<%String appointment1 = request.getParameter("appointment");
     ...
     <%String error1 = request.getParameter("error");
         ...
         <% } %>    	
	<div class="kidney-appoint">
		<form action="KidneyServlet" method="post">
			<h2>KIDNEY SPECIALIST</h2>
			<br>
			<div class="infield">
