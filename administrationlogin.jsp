	 ...
	 <div class="container-admin">
		<form action="AdminloginServlet" method="post">
            ...
            <div class="infield">
           	...
           	<p class="new_doctor">Create an account? <a href="adminsignup.jsp">Signup</a></p>
		</form>
		
	</div>
	
	<div class="group">
	<p class="text">WELCOME TO  SAFE HEALTH ADMINISTRATION LOGIN PANEL, LOGIN YOURSELF TO START THE AMAZING JOURNEY WITH US</p>
</div>
