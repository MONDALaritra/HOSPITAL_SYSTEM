...
<head>
<meta charset="UTF-8">
<title>Liver specialist appointment</title>
<style>
	body{
		background:url("Image/liver-back.jpg");
...
<%
	...
	<%String appointment1 = request.getParameter("appointment");
     ...
     <%String error1 = request.getParameter("error");
         ...
         <% } %> 
	<div class="liver-appoint">
		<form action="LiverServlet" method="post">
			<h2>LIVER SPECIALIST</h2>
			<br>
			<div class="infield">
